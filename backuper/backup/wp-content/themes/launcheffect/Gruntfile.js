	...
	grunt.initConfig({
		...
		concat: {
			...
			admin: {
				src: [
					'js/jqModal.js', 
					'functions/js/jpicker/jpicker-1.1.6.js', 
					'functions/js/jquerycookie.js', 
					'functions/js/jqueryui/js/jquery-ui-1.8.16.custom.min.js', 
					'functions/js/jquery.scrollTo-min.js',
					'functions/js/init.js'],
				dest: 'functions/js/<%= pkg.name %>-admin.js'
			},
			premium: {
				src: [ 'premium/js/jquery.countdown.js', 'premium/js/fancybox/jquery.fancybox-1.3.4.js', 'premium/js/init.js' ],
