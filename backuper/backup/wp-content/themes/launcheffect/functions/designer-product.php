...
function product_optionspanel_name() {
	$type = 'product_options';
	return $type;
}

function product_optionspanel_array() {
...
function build_le_product_page() {
?>

<div class="wrap le-wrapper">
	<?php

		lefx_tabs(product_optionspanel_name());
		lefx_subtabs(product_optionspanel_name());
	...
	<?php
		lefx_form(product_optionspanel_name(), product_optionspanel_array());
	?>
</div>
...
add_action( 'admin_init', 'register_product_fields');

function register_product_fields() {
	do_action('register_fields_hook', product_optionspanel_array(), product_optionspanel_name());
}

if (isset($_GET['activated']) && is_admin() && current_user_can('edit_posts')){
	add_action('admin_init','register_product_defaults');
	function register_product_defaults() {
		do_action('le_default_options_hook',product_optionspanel_array(), product_optionspanel_name());
	}
}
