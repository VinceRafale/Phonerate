			...
			array(
				array( // subsection
					...
					array(
						...
						'desc' => 'Enter the copy for the auto-response email body. Copy may be plain-text or HTML markup. The auto-responder is useful when you want to send a follow-up email to your recent subscribers. You may use the shortcode <strong>[launchcode]</strong> which will return the user\'s referral code and link.',
						'subtype' => '',
						'class' => '',
						'premium' => '',
