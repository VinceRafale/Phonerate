...
<form method="post" name="admin_desing_settings">
...
<?php foreach ($options as $value) { 
	...
	switch ( $value['type'] ) {
		...
		option_wrapper_header($value);
		?>
		         <input class="text_input <?php echo $value['css_class'];?>" name="<?php echo $value['id']; ?>" id="<?php echo $value['id']; ?>" type="<?php echo $value['type']; ?>" value="<?php if ( get_settings( $value['id'] ) != "") { echo get_filtered(get_settings( $value['id'] )); } else { echo get_filtered($value['std']); } ?>" />
		<?php
		option_wrapper_footer($value);
		break;
		...
		?>
			...
			<div class="fr submit submit-title">
                <input name="save" onclick="document.admin_desing_settings.submit();" type="submit" value="Save changes" />  
...
<input name="save" type="submit" onclick="document.admin_desing_settings.submit();" value="Save changes" />    
<input type="hidden" name="action" value="save" />
</p>
</form>
<form method="post">
